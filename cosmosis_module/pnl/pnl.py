...
class PowerSpectrum(object):
    ...
    def __init__(self, options):
        ...
        if self.use_window:
            ...
            window_configspace_file = os.path.join(
                path_to_window, options.get_string(option_section, "window_configspace_file")
            )
        else:
            path_to_window = None
        ...
        self.projection = pb.Projection(
            ...
            z_AP,
            cf=False,
            window_fourier_name=window_fourier_name,
            path_to_window=path_to_window,
