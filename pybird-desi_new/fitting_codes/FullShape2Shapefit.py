...
if __name__ == "__main__":
    ...
    for i in range(start, end):
        ...
        if with_w0 == True:
            theo_aperp, theo_apara, theo_fAmp, theo_mslope = interpolation_function(burntin[i, :5])[0]
        elif with_w0_wa == True:
            theo_aperp, theo_apara, theo_fAmp, theo_mslope = interpolation_function(burntin[i, :6])[0]
        else:
            theo_aperp, theo_apara, theo_fAmp, theo_mslope = interpolation_function(burntin[i, :4])[0]
