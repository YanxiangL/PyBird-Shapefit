...
def lnprior(params, birdmodel, Shaptfit):
    ...
    for i in range(nz):
        ...
        # alpha_perp, alpha_par, fsigma8 = 1.0, 1.0, birdmodel_all[0].fN*birdmodel_all[0].sigma8
...
def lnlike(params, birdmodel, fittingdata, plt, Shapefit):
    ...
    if Shapefit == False:
        ...
        # np.save('Plin_ELG_SF.npy', Plin)
        # np.save('Ploop_ELG_SF.npy', Ploop)
...
if __name__ == "__main__":
    ...
    # Plin, Ploop = birdmodel_all[0].modify_template([1.0, 1.0, start[2]], fittingdata=fittingdata, factor_m=0.0, redindex=redindex, one_nz=True)
    # print(np.shape(Plin), np.shape(Ploop))
    
    # np.save('Plin_SF_ELG.npy', Plin)
    # np.save('Ploop_SF_ELG.npy', Ploop)
    # params = start 
    ...
    # print(lnlike(np.array([1.23737826, 0.74932326, 0.74306684]), birdmodel_all, fittingdata, plt, Shapefit))
