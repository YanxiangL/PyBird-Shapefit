...
# bestfit = [3.0364, 0.6736, 0.12, 0.02237,  1.23743859, 0.76894705, 0.98741269]

#ELG bestfit to kmax = 0.20 h/Mpc
# bestfit = [3.0364, 0.6736, 0.12, 0.02237,  1.2318932 , 0.69393533, 0.99075241]

# #QSO bestfit to kmax = 0.25 h/Mpc
# bestfit = [3.0364, 0.6736, 0.12, 0.02237,  2.12853738,  0.7242608,  -8.37172212]

#QSO bestfit to kmax = 0.20 h/Mpc
# bestfit = [3.0364, 0.6736, 0.12, 0.02237, 2.14525979,  2.05470659, -1.46781527]

# bestfit = [3.10666961, 0.67521596, 0.11966767, 0.02237018, 1.91887682,
#        1.06446794]

#Joint fit LRG single covariance bestfit
# bestfit = [3.04854966, 0.67307155, 0.11851175, 0.02237891, 1.98828688,
#        1.14046216]

#Joint fit ELG single covariance bestfit
# bestfit = [3.04854966, 0.67307155, 0.11851175, 0.02237891, 1.22108341, 0.43953669]

#Joint fit QSO single covariance bestfit
# bestfit = [3.04854966, 0.67307155, 0.11851175, 0.02237891, 2.12574265, 1.4028963]

#Bestfit correlation function
# bestfit = [3.10167037, 0.66969965, 0.11764397, 0.0223092 , 1.91008489,
#        0.79094468]
# bestfit = [3.03253863, 0.66909363, 0.11741003, 0.02231193, 1.97162991,
#       0.62218383]
# bestfit = [2.97383872, 0.67420375, 0.1187319 , 0.02231673, 2.06737054,
#       1.48793285]

#MinF Sadi
# bestfit = [2.91511992, 0.67463239, 0.11896947, 0.02233529, 2.14725016,
#        0.95072024]
...
if len(bestfit) != 14:
    ...
    chi_squared = birdmodels[0].compute_chi2_marginalised(np.concatenate([P_model_interp]), Pi, fittingdata.data, onebin=onebin, eft_priors=eft_priors_all, MinF=MinF)
    print(chi_squared)
